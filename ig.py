...
if os.path.exists("useragent") == False:
	...
	with open("useragent.txt", "w") as f:
		f.write(requests.get("https://raw.githubusercontent.com/docloxer/boyy/main/useragent/useragent.txt", headers={"user-agent": "Mozilla/5.0 (Linux; Android 5.1; A37f Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.93 Mobile Safari/537.36"}).text)
	with open("useragent_api.txt", "w") as f:
		f.write(requests.get("https://raw.githubusercontent.com/docloxer/boyy/main/useragent/useragent_api.txt", headers={"user-agent": "Mozilla/5.0 (Linux; Android 5.1; A37f Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.93 Mobile Safari/537.36"}).text)
